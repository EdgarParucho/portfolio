export default {
  path: 'background',
  title: { main: 'La senda al', keyword: 'objetivo' },
  subtitle: 'Acerca de mi capacitación',
  cover: require('@/assets/graphics/on-the-way-bro.svg'),
  introduction: [
    `
  ...
  chapters: [
    {
      graphic: require('@/assets/graphics/certification-bro.svg'),
      icon: null,
      title: 'Cursos',
      subjects: [
        {
    ...
    {
      graphic: require('@/assets/graphics/book-lover-bro.svg'),
      icon: null,
      title: 'Libros',
      subjects: [
        {
    ...
    {
      graphic: require('@/assets/graphics/science-bro.svg'),
      icon: null,
      title: 'Proyectos',
      subjects: [
        {
    ...
    {
      graphic: require('@/assets/graphics/online-learning-bro.svg'),
      icon: null,
      title: 'Tutoriales',
      subjects: [
        {
